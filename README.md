...
> **국산 고추냉이 스마트팜 공간대여 서비스**
> 서울특별시 서초구 양재동 178-4 · 약 536평 · 2026년 9월 오픈 예정

향재원은 국산 고추냉이를 재배하는 **메인 하우스 스마트팜 150평**과 **8개 스마트팜 체험 데크**(각 데크별 전용 텃밭 포함)로 구성된 **스마트팜 공간대여 서비스**입니다. 일반 글램핑 숙박 시설이 아닌 **농업 체험 공간대여**이며, 예약자는 데크 전용 텃밭에서 시기별 작물을 직접 수확할 수 있습니다.
...
### 주요 서비스
- 🌱 스마트팜 체험 데크 공간대여 (평일 2타임 / 주말 3타임)
- 🌿 데크별 전용 텃밭 수확 체험 (상추·로메인·딸기·깻잎 등)
