...
const FACILITIES: FacilityInfo[] = [
  {
    ...
    thumbnail: '/facility-images/향재원 조감도 (2).png',
    images: [
      '/facility-images/향재원 조감도 (2).png',
      '/facility-images/향재원조감도 (1).jpg',
      '/facility-images/향재원조감도 (2).jpg',
      '/facility-images/향재원조감도 (3).jpg',
      '/facility-images/향재원조감도 (4).jpg',
      '/facility-images/향재원조감도 (7).png',
      '/facility-images/향재원조감도 (8).png',
      '/facility-images/향재원조감도 (9).png',
    ],
  },
  {
    key: 'store',
    ...
    thumbnail: '/facility-images/KakaoTalk_20251125_132835980_15.jpg',
    images: [
      '/facility-images/KakaoTalk_20251125_132835980_15.jpg',
      '/facility-images/KakaoTalk_20251125_132835980_23.jpg',
      '/facility-images/향재원  (6).png',
      '/facility-images/향재원  (7).png',
      '/facility-images/향재원  (16).png',
      '/facility-images/향재원  (4).jpg',
      '/facility-images/KakaoTalk_20260410_165225697.jpg',
      '/facility-images/KakaoTalk_20260410_165225697_01.jpg',
      '/facility-images/KakaoTalk_20260410_165225697_02.png',
      '/facility-images/KakaoTalk_20260410_165225697_03.png',
    ],
  },
  {
    key: 'deck',
    ...
    images: [
      ...
      '/facility-images/향재원 조감도 (4).png',
      '/facility-images/향재원 조감도 (5).png',
      '/facility-images/향재원 조감도 (6).png',
      '/facility-images/향재원 조감도 (7).png',
      '/facility-images/향재원  (1).jpg',
      '/facility-images/향재원  (4).png',
    ],
  },
  {
    key: 'site',
    ...
    thumbnail: '/facility-images/A_detailed_3D_rendering_of_a_luxurious_glamping_si-1760445157424.png',
    images: [
      '/facility-images/A_detailed_3D_rendering_of_a_luxurious_glamping_si-1760445157424.png',
      '/facility-images/A_street_view-style_3D_rendering_of_Hyangjaewons_-1760446648462.png',
      '/facility-images/A_3D_rendering_of_a_landscape_in_the_evening_rese-1760446537669.png',
